...
public class UserRepo extends BaseRepo<UserEntity> {
  ...
  public Optional<UserEntity> findByUsername(String username) {
    ...
    List<UserEntity> users = super.jdbc.query(sql, new BeanPropertyRowMapper<>(UserEntity.class), username);
  ...
  public UserEntity createUser(String username, String passwordHash) {
    ...
    // String sql = "INSERT INTO users (id, username, email, password_hash,
    // created_at) VALUES (?, ?, ?, ?, ?)";
