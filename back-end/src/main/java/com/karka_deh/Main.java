...
@OpenAPIDefinition(info = @Info(title = "Karka Deh API", version = "v1", description = "Karka Deh is an articles site, allowing students to post and get answers from others", contact = @Contact(name = "Abdullah Al-Banna", email = "abdu.albanna@proton.me"), license = @License(name = "GPL-3.0")), servers = @Server(url = "http://localhost:8080", description = "Local server"))
