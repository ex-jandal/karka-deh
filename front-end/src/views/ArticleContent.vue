...
<template>
  <div v-if="notFound" class="fixed top-0 right-0 h-screen w-screen flex flex-col gap-5 justify-center items-center text-2xl text-gray-400 font-bold">
  ...
  <section v-else class="article pt-20 flex flex-col justify-center">
    <h2 class="text-6xl pb-3 leading-18">{{ title }}</h2>
