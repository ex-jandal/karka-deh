...
<template>
  <div
    class="login-section w-full md:w-150 flex flex-col justify-center items-center sm:rounded-4xl"
  >
    ...
    >
      <div
        class="login-oauth border-b-1 border-gray-300 pb-5 p-1 flex flex-row justify-center gap-20 w-full text-3xl"
      >
        <button
      ...
      <form @submit.prevent="signin" class="flex flex-col gap-4 w-full" action="">
        <div class="input-feild flex flex-col sm:flex-row gap-4 sm:gap-[2%]">
          ...
          <input
            id="frist-name"
            class="p-2 pl-10 block rounded-4xl bg-white text-black sm:w-[49%] border-2"
            type="text"
          ...
          <input
            id="last-name"
            class="p-2 pl-5 block rounded-4xl bg-white text-black sm:w-[49%] border-2"
            type="text"
        ...
        <button
          class="submit bg-third-color text-fourth-color mt-2 cursor-pointer p-2 block rounded-4xl hover:rounded-xl hover:scale-105 hover:bg-fourth-color hover:text-third-color transition-all"
          type="submit"
        >
          Signin
        </button>
